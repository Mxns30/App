...
const PostCreate: React.FC = () => {
  ...
  const validateForm = (): boolean => {
    ...
    if (!formData.price.trim()) {
      ...
      if (Number.isFinite(priceNum) && priceNum > 10000000) {
        newErrors.price = '가격은 10,000,000원 이하만 입력 가능합니다';
        isValid = false;
      }
    }
  ...
  return (
    <Box component="form" onSubmit={handleSubmit} sx={{ maxWidth: 600, mx: 'auto', p: 3 }}>
      ...
      <Button
        ...
        color="primary"
        fullWidth
        disabled={isSubmitting || !formData.price.trim() || Number(formData.price) > 10000000}
        sx={{ mt: 2 }}
      >
